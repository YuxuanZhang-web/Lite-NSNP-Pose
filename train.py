...
import os
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '2'  # 屏蔽 TensorFlow 的警告信息
...
from models.nsnppose   import get_nsnppose
...
def parse_args():
    ...
    parser.add_argument('--cfg',          help='experiment configure file name',
                        default='experiments/coco/nsnppose_w48_256x192.yaml', type=str)
...
def main(args):
    ...
    elif cfg.MODEL.NAME == 'nsnppose':
        model = get_nsnppose(cfg, is_train=True)
